 ...
 */
import type { HealthResponse, InfoResponse, DiagnosticsResponse, ConfigResponse, LogsResponse, LogSource, UsersResponse, User, InviteUserRequest, InvitationResponse, BansResponse, ApiKeysResponse, ApiKey, CreateApiKeyRequest, UpdateApiKeyRequest, AvailableScopesResponse, KeyUsageResponse, EntitlementsStatus, UiContributionsResponse, PluginsResponse, AuthConfigStatus, RuntimeAuthConfig, UpdateAuthConfigRequest, TestProviderRequest, TestProviderResponse, NotificationsStatsResponse, NotificationsClientsResponse, RateLimitConfigUpdateRequest, RateLimitConfigUpdateResponse, PreferencesResponse } from './controlPanelApi.js';
/**
...
export interface APIClientManifest {
    routes: {
        ...
        'core.uiContributions': {
            method: 'GET';
            path: '/api/ui-contributions';
            auth: false;
        };
        'core.plugins': {
            method: 'GET';
        ...
        'notifications.clients': {
            method: 'GET';
            path: '/api/notifications/clients';
            auth: true;
        };
        'rateLimit.config': {
            method: 'GET';
