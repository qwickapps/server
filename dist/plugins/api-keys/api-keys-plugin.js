 ...
 */
import { CreateApiKeySchema, UpdateApiKeySchema, } from './types.js';
// Store instance for helper access
let currentStore = null;
/**
 * Create the API Keys plugin
 */
export function createApiKeysPlugin(config) {
 ...
 */
export async function verifyApiKey(plaintextKey) {
    if (!currentStore) {
 ...
 */
export async function getApiKey(userId, keyId) {
    if (!currentStore) {
        throw new Error('API Keys plugin not initialized');
    }
 ...
 * Update an API key
 */
export async function updateApiKey(userId, keyId, params) {
    if (!currentStore) {
        throw new Error('API Keys plugin not initialized');
    }
...
//# sourceMappingURL=api-keys-plugin.js.map