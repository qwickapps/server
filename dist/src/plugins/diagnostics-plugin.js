...
export function createDiagnosticsPlugin(config = {}) {
    const { include = { logs: { startup: 100, app: 200 }, health: true, config: true, system: true }, logPaths = { startup: './logs/startup.log', app: './logs/app.log' }, endpoint = '/full', // Framework adds /diagnostics prefix automatically
     } = config;
    return {
        id: 'diagnostics',
